                ...
                <tbody>   
                    <?php 
                        ...
                        <td class="text-center">
                                <a href="branch.php?edit=<?php echo $row['bid']?>"><button class="btn btn-sm btn-primary">Edit</button> </a>
                                <!-- <a onclick="del(<?php echo $row['bid']; ?>)"><button class="btn btn-sm btn-danger deletebutton" type="button">Delete</button></a>  --></td>
                        </tr>
                        <?php
                        }
                    ?>    
