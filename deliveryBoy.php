...
<div class="page-content container-fluid">
    <div class="footer">
        <div class="d-flex justify-content-center">
            <h2 class="" style=" font-weight: 600">Delivery Boy List's</h2>
        </div>
        <hr style="margin: 0px;">      
    </div>
</div>
            ...
            <table id="example" class="cell-border" style="width:100%">
                ...
                <tbody>   
                    <?php 
                            ...
                            $qr="SELECT * FROM `staff` WHERE `des`='Delevery Boy'";
                            ...
                            while($row=mysqli_fetch_array($ex))
                            {
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><a href="#" ><button class="btn btn-sm btn-info editbutton" type="button">view</button><a></td>
