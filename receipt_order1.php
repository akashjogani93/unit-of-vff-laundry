...
if(isset($_GET['view']))
{
    ...
    $CoId=$_GET['view'];
    //echo $CoId;
    $qry1="SELECT * FROM `couterorder` WHERE `coId`='$CoId' ";
                        ...
                        <div class="panel-title">
                            ...
                            while($o=mysqli_fetch_array($con)) 
                            {
                                ?>     
                                    ...
                                    <center><P style="float:right;"><b>GSTIN:- <?php echo $o['gst']; ?></b></p><h6 >UNIT OF VFF GROUP</h6> </center>
                    ...
                    { 
                        ...
                        <div class="row">
                            ...
                            <div class="col-offset-sm-4" style="margin-left: 30px;">
                                <div class="form-group">
                                    <label><b>Date:- </b><?php echo $pickupDate; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-offset-sm-4" style="margin-left: 30px;">
                                <div class="form-group">
                                <label><b>Recipet No:- </b><?php echo $CoId; ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-offset-sm-4" style="margin-left: 30px;">
                                <div class="form-group">
                                <label><b>Payment:- </b><?php echo $payment; ?></label>
                                </div>
                            </div>
                        </div>
