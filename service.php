            ...
            <tbody>
                <?php 
                    ...
                    <td class="text-center">
                            <a href="service.php?edit=<?php echo $row['sid']?>"><button class="btn btn-sm btn-danger">Edit</button> </a>
                            <!-- <a onclick="del(<?php echo $row['sid']; ?>)"><button class="btn btn-sm btn-danger deletebutton" type="button">Delete</button></a> -->
                        </td> 
                    </tr>
                    <?php
                    }
...
<script>
  function del(sid){
    if(confirm("Are you sure?")==true){
      location = "service_submit.php?del="+sid;
    }else {
