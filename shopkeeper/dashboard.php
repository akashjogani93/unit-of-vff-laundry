    ...
    <div class="row p-4">
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem; background-color:rgb(216, 217, 207)">
                    ...
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE `orderType`='Online' AND `status`= '10' AND `bid`= '$bid';"); ?></b><p class="card-text"><b>Online Order Requests</b></p>
                    </div></a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem; ">
                    ...
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE `orderType`='Counter' AND `status`= '0' AND `bid`= '$bid';"); ?></b><p class="card-text"><b>Counter New Order</b></p>
                    </div></a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem; background-color:rgb(216, 217, 207)">
                    ...
                    <img src="assets/image/105267335-wicker-basket-with-clothes-on-ironing-board-at-dry-cleaner-s.webp" class="card-img-top" height="100px" alt="...">
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE `status`= '1' AND `bid`= '$bid' ;"); ?></b><p class="card-text"><b>Underprocess Orders</b></p>
                    </div></a>
                </div>
            </div>
        </div>
        <div class="row p-4">
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE  `status`= '3' AND `bid`= '$bid' ;"); ?></b><p class="card-text"><b>Asigned For Delivery</b></p>
                    </div></a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem; background-color:rgb(216, 217, 207);">
                    ...
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE `orderType`='Online' AND `status`= '4' AND `bid`= '$bid' ;"); ?></b><p class="card-text"><b>Online Order Completed</b></p>
                    </div></a>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <b style="font-size:32px; color:black;"><?php echo get_Dash_Data($conn,"SELECT  COUNT(`CoId`) FROM `couterorder` WHERE `orderType`='Counter' AND `status`= '4' AND `bid`= '$bid' ;"); ?></b><p class="card-text"><b>Counter Order Completed</b></p>
                    </div></a>
                </div>
            </div>
        </div>
